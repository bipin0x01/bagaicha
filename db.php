<?php
/**
 * Bagaicha SQLite3 Database Connection & Setup
 * Creates database and tables dynamically if not present,
 * and seeds standard product catalogs.
 */

$db_file = __DIR__ . '/assets/database/bagaicha.db';
...
// Drop legacy users table if it does not contain the new 'phone' column (forcing schema migration)
...
// 6. Migrate Orders Table to support payment_method
