...
<body class="bg-gray-50/30 text-gray-800 antialiased font-sans">
                    ...
                    <div class="border border-gray-100 rounded-2xl p-6 bg-gray-50/50 mt-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto">
                            ...
                            <label class="payment-card relative flex-1 min-w-[140px] border-2 border-primary bg-purple-50/20 rounded-xl p-5 cursor-pointer flex flex-col items-center justify-center gap-3 transition-all select-none">
                                ...
                                <img src="/assets/img/misc/esewa_logo.png" alt="Pay via eSewa" class="h-10 w-auto object-contain">
    ...
    <script>
        ...
        function renderCheckoutSummary() {
            ...
            if (cart.length === 0) {
                window.showModal("Cart Empty", "Your shopping cart is empty! Let's take you back to the Shop page so you can select some items.", "error");
                setTimeout(() => {
        ...
        function validateCheckoutForm() {
            const cart = getCart();
            if (cart.length === 0) {
                window.showToast("Cart Empty", "Your shopping cart is empty!", "error");
                return false;
            }
            ...
            if (!phonePattern.test(phone)) {
                window.showToast("Phone Number Error", "Please enter a valid Nepalese phone number (10 digits starting with 98 or 97)!", "error");
                return false;
            }
