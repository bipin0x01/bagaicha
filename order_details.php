...
<body class="bg-gray-50/30 text-gray-800 antialiased font-sans">
    ...
    <main class="max-w-7xl mx-auto py-12 md:py-16 px-6 md:px-12">
        ...
        <div class="flex items-center justify-between mb-8 animate-fade-in">
            <a href="<?php echo $is_admin ? './admin.php' : './profile.php'; ?>" class="text-xs font-bold text-primary hover:text-primary-dark flex items-center gap-1.5 transition-colors">
